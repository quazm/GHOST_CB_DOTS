...
public:
	...
	string m_ObserverSlots;					// config value: слоты в которые нельзя свапать
	string m_TMProotPassword;				// config value: пароль от временной админки	
	...
	string CalcStatString(CMap* map);
};
