...
protected:
	...
	vector<string> m_GameSlotsStatuses;
	...
	string m_ObserverSlots;								//слоты, в которые нельзя свапать
	string m_TmpRootAdmins;								//временные админы
	//
...
public:
	...
	virtual vector<string>	GetGameSlotsStatuses( )	{ return m_GameSlotsStatuses; }
	...
	//tmp root function
	virtual string GetTmpRootAdmins( )				{ return m_TmpRootAdmins; }
	virtual void AddTmpRootAdmin(string name);
	virtual bool IsTmpRootAdmin(string name);
	//---
