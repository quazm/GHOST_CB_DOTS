...
//
//CTCPStatusBroadcasterSocket
//

CTCPStatusBroadcasterSocket::CTCPStatusBroadcasterSocket(CTCPSocket *inc_socket)
{
    socket = inc_socket;
}

CTCPStatusBroadcasterSocket::~CTCPStatusBroadcasterSocket()
{
}
